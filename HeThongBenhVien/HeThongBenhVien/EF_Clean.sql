...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260603133351_UpdateSchema_Final'
)
BEGIN
...
BEGIN
    IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[Users]') AND name = N'PatientCode') 
...
BEGIN
    IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[Patients]') AND name = N'Allergies') 
...
BEGIN
    IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[Patients]') AND name = N'CCCD') 
...
BEGIN
    IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[Patients]') AND name = N'FaceData') 
...
BEGIN
    IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[MedicalRecords]') AND name = N'DigitalSignature') 
...
BEGIN
    IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[MedicalRecords]') AND name = N'IsLocked') 
...
BEGIN
    IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[LabTests]') AND name = N'ImageUrl') 
...
BEGIN
    IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[ICD10Protocols]') AND type in (N'U'))
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260607033133_AddNotificationEntity'
)
BEGIN
    CREATE TABLE [Notifications] (
        ...
        CONSTRAINT [FK_Notifications_Patients_PatientId] FOREIGN KEY ([PatientId]) REFERENCES [Patients] ([Id]) ON DELETE CASCADE,
        CONSTRAINT [FK_Notifications_Users_DoctorId] FOREIGN KEY ([DoctorId]) REFERENCES [Users] ([Id]) ON DELETE CASCADE
    );
END;
GO
...
BEGIN
    CREATE INDEX [IX_Notifications_DoctorId] ON [Notifications] ([DoctorId]);
END;
GO
...
BEGIN
    CREATE INDEX [IX_Notifications_PatientId] ON [Notifications] ([PatientId]);
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260607033133_AddNotificationEntity', N'8.0.0');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260611031313_AddNotificationsTable'
)
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260611031313_AddNotificationsTable', N'8.0.0');
END;
GO
